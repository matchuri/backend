...
public enum GroupErrorCode implements ErrorCode {
    ...
    RECOMMENDATION_CANCEL_FORBIDDEN(HttpStatus.FORBIDDEN, "그룹 추천 준비 세션 취소 권한이 없습니다. groupId : {0}"),
    RECOMMENDATION_CANCEL_CONFLICT(HttpStatus.CONFLICT, "취소 가능한 준비 중인 그룹 추천이 아닙니다. sessionId : {0}, status : {1}"),
