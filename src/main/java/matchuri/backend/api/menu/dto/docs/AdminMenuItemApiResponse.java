...
@Schema(description = "관리자 메뉴 단건 API의 공통 응답 envelope입니다.")
public record AdminMenuItemApiResponse(
        @Schema(description = "요청 성공 여부입니다.", example = "true")
        boolean success,

        @Schema(description = "성공 시 반환되는 관리자 메뉴 정보입니다.")
        AdminMenuItemResponse data,
