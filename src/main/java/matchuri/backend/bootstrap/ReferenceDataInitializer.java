...
public class ReferenceDataInitializer {
    ...
    private int createIngredients() {
        ...
        createdCount += createIngredientIfAbsent("EGG", "계란", true, 10);
        createdCount += createIngredientIfAbsent("MILK", "우유", true, 20);
        createdCount += createIngredientIfAbsent("BUCKWHEAT", "메밀", true, 30);
        createdCount += createIngredientIfAbsent("PEANUT", "땅콩", true, 40);
        createdCount += createIngredientIfAbsent("SOYBEAN", "대두", true, 50);
        createdCount += createIngredientIfAbsent("WHEAT", "밀", true, 60);
        createdCount += createIngredientIfAbsent("PINE_NUT", "잣", true, 70);
        createdCount += createIngredientIfAbsent("WALNUT", "호두", true, 80);
        createdCount += createIngredientIfAbsent("CRAB", "게", true, 90);
        createdCount += createIngredientIfAbsent("SHRIMP", "새우", true, 100);
        createdCount += createIngredientIfAbsent("SQUID", "오징어", true, 110);
        createdCount += createIngredientIfAbsent("MACKEREL", "고등어", true, 120);
        createdCount += createIngredientIfAbsent("SHELLFISH", "조개류", true, 130);
        createdCount += createIngredientIfAbsent("PEACH", "복숭아", true, 140);
        createdCount += createIngredientIfAbsent("TOMATO", "토마토", true, 150);
        createdCount += createIngredientIfAbsent("CHICKEN", "닭고기", true, 160);
        createdCount += createIngredientIfAbsent("PORK", "돼지고기", true, 170);
        createdCount += createIngredientIfAbsent("BEEF", "쇠고기", true, 180);
        createdCount += createIngredientIfAbsent("SULFITES", "아황산류", true, 190);
        createdCount += createIngredientIfAbsent("KIWI", "키위", true, 200);
        createdCount += createIngredientIfAbsent("CASHEW_NUT", "캐슈넛", true, 210);
        createdCount += createIngredientIfAbsent("PUPA", "번데기", true, 220);
        createdCount += createIngredientIfAbsent("YAM", "마", true, 230);
        createdCount += createIngredientIfAbsent("SESAME", "참깨", true, 240);

        createdCount += createIngredientIfAbsent("FISH", "생선", false, 310);
        createdCount += createIngredientIfAbsent("TOFU", "두부", false, 320);
        createdCount += createIngredientIfAbsent("KIMCHI", "김치", false, 330);
        createdCount += createIngredientIfAbsent("CHEESE", "치즈", false, 340);
        createdCount += createIngredientIfAbsent("CILANTRO", "고수", false, 350);
        createdCount += createIngredientIfAbsent("EGGPLANT", "가지", false, 360);
        createdCount += createIngredientIfAbsent("MUSHROOM", "버섯류", false, 370);
        createdCount += createIngredientIfAbsent("CUCUMBER", "오이", false, 380);
        createdCount += createIngredientIfAbsent("GREEN_PEPPER", "피망", false, 390);
        createdCount += createIngredientIfAbsent("PAPRIKA", "파프리카", false, 400);
        createdCount += createIngredientIfAbsent("BROCCOLI", "브로콜리", false, 410);
        createdCount += createIngredientIfAbsent("ONION", "양파", false, 420);
        createdCount += createIngredientIfAbsent("GARLIC", "마늘", false, 430);
        createdCount += createIngredientIfAbsent("GREEN_ONION", "파", false, 440);
        createdCount += createIngredientIfAbsent("GARLIC_CHIVE", "부추", false, 450);
        createdCount += createIngredientIfAbsent("WATER_PARSLEY", "미나리", false, 460);
        createdCount += createIngredientIfAbsent("PERILLA_LEAF", "들깻잎", false, 470);
        createdCount += createIngredientIfAbsent("CELERY", "셀러리", false, 480);
        createdCount += createIngredientIfAbsent("OLIVE", "올리브", false, 490);
        createdCount += createIngredientIfAbsent("BLUE_CHEESE", "블루치즈류", false, 500);
        createdCount += createIngredientIfAbsent("OFFAL", "내장류", false, 510);
        createdCount += createIngredientIfAbsent("STRONG_FISHY_FISH", "생선 비린 향 강한 재료", false, 520);
        createdCount += createIngredientIfAbsent("STRONG_SEAFOOD_AROMA", "해산물 향 강한 재료", false, 530);
        createdCount += createIngredientIfAbsent("AROMATIC_SPICES", "향신채/향신료 계열", false, 540);
